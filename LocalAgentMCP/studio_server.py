    ...
    try:
        while True:
            ...
            payload = {
                ...
                "messages": [{"role": "system", "content": current_model.get("system_prompt", "")}] + history_storage[model_key],
                "tools": ollama_tools,
                "stream": False,
                "options": {"num_ctx": 8192}
            }

            await websocket.send_json({"type": "status", "text": f"{current_model['label']} 생각 중..."})
